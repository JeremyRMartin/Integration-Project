...
public class Person {
  ...
  private int karma = 0;
  /*
   * Inheritance is super helpful for an example with this class being a parent class to the class
   * Player.
   * 
   * It allows me to extend all the methods written here, and apply them to the class player, this
   * allows me to have any object made of class player, to gain all of the methods available in
   * Person.
   * 
   */
  ///////////////// Methods///////////////////////
  ...
  public void cough() throws InterruptedException {// cough sequence
    ...
    String[] s =
        {"*COUGH*", "*HACK*", "*WHEEZE*", "*HAAAACK*", "*WHEEEEEZE*", "*HEP*", "*UCCCHHH*"};
